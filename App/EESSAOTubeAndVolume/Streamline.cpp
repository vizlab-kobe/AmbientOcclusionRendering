...
kvs::Vec3 Streamline::StructuredVolumeInterpolator::interpolatedValue( const kvs::Vec3& point )
{
    ...
    const kvs::Real32* Sx = m_grid->values();
    const kvs::Real32* Sy = Sx + m_grid->numberOfCellNodes();
    const kvs::Real32* Sz = Sy + m_grid->numberOfCellNodes();
    for ( size_t i = 0; i < m_grid->numberOfCellNodes(); i++ )
    {
...
Streamline::Streamline(
    ...
    StochasticStreamline::StreamlineBase()
{
