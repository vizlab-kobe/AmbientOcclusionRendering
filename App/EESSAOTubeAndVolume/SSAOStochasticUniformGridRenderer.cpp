    ...
    kvs::Light* light )
{
    ...
    attachObject( object );
    createRandomTexture();
    this->create_geometry_shader_program( volume );
...
{
    m_random_index = m_geom_pass_shader.attributeLocation("random_index");
 ...
 */
/*===========================================================================*/
void SSAOStochasticUniformGridRenderer::Engine::create_geometry_shader_program( const kvs::StructuredVolumeObject* volume )
{
