...
public:
    ...
    {
        // Initial values.
        auto* volume = m_model.cachedVolume();
        ...
        m_opacity_slider.sliderReleased( [&] ()
        {
            ...
            object->shallowCopy( *kvs::PolygonObject::DownCast( m_view.screen().scene()->object( "Object" ) ) );
            object->setOpacity( kvs::Math::Round( m_opacity_slider.value() * 255 ) );
            m_view.screen().scene()->replaceObject( "Object", object );
        } );
