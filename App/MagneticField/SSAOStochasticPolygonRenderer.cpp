...
void SSAOStochasticPolygonRenderer::setEdgeControl( const float edge_control )
{
    static_cast<Engine&>( engine() ).setEdgeControl( edge_control );
}
    ...
    kvs::Light* light )
{
    ...
    m_ao_buffer.geometryPassShader().setUniform( "edge_control", m_edge_control );
