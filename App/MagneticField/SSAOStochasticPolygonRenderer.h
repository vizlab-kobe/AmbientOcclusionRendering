...
public:
    ...
    void setEdgeControl( const float edge_control );
};
...
private:
    ...
    float m_edge_control; ///< edge enhancement control factor
...
public:
    ...
    void setEdgeControl( const float edge_control ) { m_edge_control = edge_control; }
