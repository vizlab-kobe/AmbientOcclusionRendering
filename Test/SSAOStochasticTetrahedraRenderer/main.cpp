...
#include <AmbientOcclusionRendering/Lib/SSAOStochasticTetrahedraRenderer.h>
typedef kvs::StochasticTetrahedraRenderer NoSSAORenderer;
typedef AmbientOcclusionRendering::SSAOStochasticTetrahedraRenderer SSAORenderer;
...
inline kvs::UnstructuredVolumeObject* ImportVolumeObject( const std::string& filename )
{
    return new kvs::UnstructuredVolumeImporter( filename );
}
...
int main( int argc, char** argv )
{
    ...
    kvs::UnstructuredVolumeObject* object = ::ImportVolumeObject( argv[1] );
